...
{
 //make sure customer is allowed to view and respond
...
{
  // this is for the drop down menu thing
...
// set options for the rankin dropdown
 $options[''] = 'Select...';
 $options['1'] ='One Star';
 $options['2'] ='Two Stars';
