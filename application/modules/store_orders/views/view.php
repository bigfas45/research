...
<div class="row-fluid sortable">
		<div class="box span12">
			...
			<div class="box-content">
              <p>TO udate the order status please choose an option from the drop down below </p>
...
<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
	<p style="text-align: right;>"><a href="<?= base_url() ?>store_accounts/create/<?= $shopper_id ?>">	<button type="button" class="btn btn-info">Edit Account Details</button></a></p>
