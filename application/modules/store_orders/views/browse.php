...
<a href="<?= $paypal_url;?>"><button type="submit" class="btn btn-primary">Vist Paypal</button></a> 
</p>
<?php
if ($num_rows < 1) {
...
<h2><i class="halflings-icon white user"></i><span class="break"></span>Your orders</h2>
<div class="box-icon">
...
$order_status = 'Order Submitted'; //order status is 0 
}
