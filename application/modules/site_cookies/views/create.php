...
<div class="row-fluid sortable">
		...
		?>
			<a href="<?= base_url() ?>store_items_color/update/<?= $update_id;?>">	<button type="button" class="btn btn-primary">Upload Item Colors</button></a>
			<a href="<?= base_url() ?>store_items_sizes/update/<?= $update_id;?>">	<button type="button" class="btn btn-primary">Upload Item Sizes</button></a>
			<a href="<?= base_url() ?>store_cat_assign/update/<?= $update_id?>">	<button type="button" class="btn btn-primary">Upload Item Categories</button></a>			<a href="
