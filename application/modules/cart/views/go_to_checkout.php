...
<p>Creating an account only takes a minutes or so and it's a good vibe.</p>
...
<div class="col-md-10" style="margin-top: 36px;">
	...
	<button class="btn btn-danger" style="margin-left: 24px;" name="submit" value="No" type="submit">
