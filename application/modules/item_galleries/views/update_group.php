...
<a href="<?= base_url() ?>item_galleries/upload_image/<?= $parent_id ?>" role="button" class="btn btn-primary" data-toggle="modal">Upload New Picture</a>
...
<?php
	if ($num_rows < 1) {
		echo "<p> So far, you have not uploaded any gallery $entity_name for $parent_title .";
	} else{
	?>
