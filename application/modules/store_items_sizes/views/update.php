...
<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						...
						<?php
							$form_location = base_url()."store_items_sizes/submit/".$update_id;
						...
						<form method="post" class="form-horizontal" action="<?= $form_location;?>" >
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6" name="sizes" >
							  </div>
							</div>
	...
	<div class="box-content">
						<table class="table table-striped table-bordered">
						  ...
						  <tbody>
						  	...
						  	$count++;
						  	 $delete_url = base_url()."Store_items_sizes/delete/".$row->id;
						  	   ?>
							<tr>
								<td><?= $count;?></td>
								<td class="center"><?= $row->sizes;?></td>
