...
<form action="<?= $form_location ?>" method="post" style="margin-top: 24px;">
  ...
  <div class="form-group">
    ...
    <input type="text" name="subject" value="<?=$subject?>" class="form-control" id="subject" placeholder="Subject">
  </div></form><?php
  } else {
 ...
 ?>
  <div class="form-group">
    ...
    <textarea class="form-control" name="message" rows="6" placeholder="Enter Your Message"><?= $message?></textarea>
  </div>
