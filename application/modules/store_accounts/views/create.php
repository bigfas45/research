...
<div class="row-fluid sortable">
		<div class="box span12">
			...
			<a href="<?= base_url() ?>store_accounts/deleteconf/<?= $update_id;?>">	<button type="button" class="btn btn-danger">Delete Acoount</button></a>
			</div>
		</div><!--/span-->
...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Accounts Details</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
						</div>
					...
					<div class="box-content">
						...
						<form method="post" class="form-horizontal" action="<?= $form_location;?>" >
						  <fieldset>
							<div class="control-group"> <label class="control-label" for="typeahead">User Name </label> <div class="controls"> <input type="text" class="span6" name="username" value="<?= $username;?>"> </div> </div>
