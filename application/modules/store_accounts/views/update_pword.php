					...
					<div class="box-content">
						...
						<form method="post" class="form-horizontal" action="<?= $form_location;?>" >
						  <fieldset>
							...
							<div class="control-group"> <label class="control-label" for="typeahead">Confrim Password </label> <div class="controls"> <input type="password" class="span6" name="repeat_pword" > </div> </div>
